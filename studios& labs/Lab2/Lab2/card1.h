...
enum success_fail { empty_deck = -7, success = 0, fail = -1, wrong_name = -2, null_file = 2, invalid_command_line = 1, big_problem = -5, invalid_vector = -20 ,short_cards = -17, invalid_usage = -22};
