...
card::card()
	:suits(suit::c), rank(card_rank::two),face_up(true)
{}
card::card(suit suit_name, card_rank rank_name)
	: suits(suit_name), rank(rank_name), face_up(true)
{}

card::card(suit suit_name, card_rank rank_name, bool up)
	: suits(suit_name), rank(rank_name), face_up(up)
{}
